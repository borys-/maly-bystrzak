...
builder.Services.AddSingleton<IWorksheetModule, PictureEquationsModule>();
builder.Services.AddSingleton<IWorksheetModule, ArithmeticCodeModule>();
builder.Services.AddSingleton<IWorksheetModule, MathCrosswordModule>();
builder.Services.AddSingleton<IWorksheetModule, ProductGridModule>();
builder.Services.AddSingleton<IWorksheetModule, WordPathModule>();
