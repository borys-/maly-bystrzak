...
public static class DifficultyReport
{
    ...
    public static byte[] Create(IReadOnlyList<GeneratedWorksheet> worksheets)
    {
        ...
        content.AppendLine("Numer;Typ;Wynik_0_100;Gwiazdki;Luka_informacyjna;Obciazenie_wyboru;Obciazenie_wiezow;Pamiec_robocza;Arytmetyka;Opis;Czas_sekundy;Bledy;Podpowiedzi;Wysilek_1_5;Ukonczone_TAK_NIE");
        foreach (var worksheet in worksheets)
        {
            var value = worksheet.Difficulty;
            content.AppendLine(string.Join(';', worksheet.Number, worksheet.TypeName, value.Score,
